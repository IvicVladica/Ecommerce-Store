...
if(isset($_GET['id'])) {
    ...
    while($row = fetch_array($query)) {
        ...
        $product_photo = display_image($product_image);
...
<div class="form-group">
    ...
    <div class="form-group">
           <label for="product-short_desc">Product Short Description</label>
...
<!-- Product Tags -->
    ...
    <div class="form-group">
        ...
        <img width='200' src="../../resources/<?php echo $product_photo ?>" alt="">
